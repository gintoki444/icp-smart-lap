...
import { getAllServiceRequests, getAllServiceRequestByUser } from 'services/_api/serviceRequest';
      ...
      renderCell: (params) => (
        <ButtonGroup>
          <Button
            ...
            size="sm"
            onClick={() => {
              navigate('/admin/request-reviewed/' + params.row.id);
            }}
          >
  ...
  return (
    <Card>
      <Card.Header>
        <Row>
          <Col>
            <Card.Title as="h5">ทบทวนคำขอ</Card.Title>
          </Col>
        </Row>
      </Card.Header>
...
export default RequestReviewedPage;
