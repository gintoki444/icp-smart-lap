...
const EditServiceRequest = ({ userId: propUserId }) => {
  ...
  const mapApiToFormValues = (apiData, companyData) => {
    ...
    return {
      ...
      fertilizerRecords: submissions.map((sub) => ({
        ...
        sameReportCompany:
          sub.report_company_name === companyData?.company_name && sub.report_company_address === companyData?.company_address,
        ...
        report_company_name: firstSubmission.report_company_name || '',
        report_company_address: firstSubmission.report_company_address || ''
      })),
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      console.log('originalData.sample_submissions :', originalData.sample_submissions);
      console.log('values.fertilizerRecords :', values.fertilizerRecords);
