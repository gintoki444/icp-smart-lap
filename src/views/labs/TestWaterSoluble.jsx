...
const TestWaterSolubleLists = () => {
  ...
  return (
    <div className="">
      <Card>
        <Card.Header>
          <h5>ข้อมูลผลการทดสอบ Water Soluble Potassium</h5>
        </Card.Header>
          ...
          <Table striped bordered hover responsive className="mb-0">
            <thead>
              <tr>
                ...
                <th>Sample Wt. (g)</th>
                <th>V (mL)</th>
                <th>Reading Signal</th>
                <th>ppm K from Curve</th>
                <th>WK₂O (%)</th>
                <th>Analyzed by</th>
                <th>Analyzed date</th>
...
export default TestWaterSolubleLists;
