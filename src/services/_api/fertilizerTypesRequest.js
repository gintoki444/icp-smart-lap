...
//  ✅ get by id ลักษณะปุ๋ย-เม็ด, เกล็ด
...
//  ✅ put by id ลักษณะปุ๋ย-เม็ด, เกล็ด
export const putFertilicerType = async (id, data) => {
  const myHeaders = new Headers();
  myHeaders.append('Content-Type', 'application/json');
  const raw = JSON.stringify(data);
...
//  ✅ delete by id ลักษณะปุ๋ย-เม็ด, เกล็ด
